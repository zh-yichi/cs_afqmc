...
if rank == 0:
    ...
    print('num_steps \t system1_en \t err \t \t system2_en \t err \t \t en_diff \t err')
    print(f'{len(loc_steps)} \t \t {energy1:.6f} \t {energy1_err:.6f} \t {energy2:.6f} \t {energy2_err:.6f} \t {en_diff:.6f} \t {weight_en_diff_err:.6f}')