...
def _block_scan(
    ...
    return prop_data, (blk_wt, blk_o, blk_e)
...
def _sr_block_scan(
    ...
    prop_data, (blk_wt, blk_o, blk_e)= lax.scan(
...
def run_afqmc(options,nproc=None,
    ...
    os.system(
        ...
        f"{mpi_prefix} python {script} {gpu_flag} |tee afqmc_ccsd_hf.out"
    )