...
if rank == 0:
    print()
    print("# check local quantities")
comm.Barrier()

comm.Barrier()
for r in range(size):
    if rank == r:
        print(f"# local energy 1 \n {loc_en1}")
        print(f"# local energy 2 \n {loc_en2}")
        print(f"# local weight 1 \n {loc_weight1}")
        print(f"# local weight 2 \n {loc_weight2}")
comm.Barrier()

comm.Barrier()
if rank == 0:
    print()
    print("# check global quantities")
comm.Barrier()

comm.Barrier()
if rank == 0:
    print("# global energy 1")
    print(glb_en1)
    print("# global energy 2")
    print(glb_en2)
    print("# global weight 1")
    print(glb_weight1)
    print("# global weight 2")
    print(glb_weight2)
comm.Barrier()
