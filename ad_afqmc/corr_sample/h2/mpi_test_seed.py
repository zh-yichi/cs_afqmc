...
## analyze the walkers of the last step of a given seed ##
## useful for investigating outliners ##
...
#     if rank == 9:  print(wt1_z)
#     z_thresh = 5
#     prop_data1["weights"] = jnp.array(jnp.where(wt1 > 5, 0.0, wt1))
#     prop_data2["weights"] = jnp.array(jnp.where(wt1 > 5, 0.0, wt2))
...
# prop_data1_rlx, prop_data2_rlx = corr_otler_rm(prop_data1_rlx, prop_data2_rlx)
